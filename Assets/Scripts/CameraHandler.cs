...
namespace SG
{
    ...
    public class CameraHandler : MonoBehaviour
    {
        ...
        public void HandleCameraRotation(float deleta, float mouseXInput, float mouseYInput)
        {
            lookAngle += (mouseXInput * lookSpeed) / deleta;
            pivotAngle -= (mouseYInput * pivotSpeed) / deleta;
            // 将相机中心点限制在固定区间
